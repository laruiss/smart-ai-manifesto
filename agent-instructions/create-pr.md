...
7. Include a closing reference for the issue at the end of the PR body:
...
9. Show a summary with the PR URL, title, base branch, current branch, and issue ID.
...
- Show the created PR URL and a concise summary.
