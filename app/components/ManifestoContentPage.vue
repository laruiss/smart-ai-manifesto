...
const activeLanguage = computed<Language>(() => {
  if (route.query.lang === 'en' || route.path.startsWith('/en')) {
    return 'en'
  }
...
useSeoMeta(() => ({
  ...
  description:
    ...
    (activeLanguage.value === 'fr'
      ? "Manifeste et principes pour utiliser l'IA intelligemment dans le développement logiciel."
...
<template>
  <main class="page">
    <div class="top-actions">
      <nav class="section-nav" :aria-label="ui.navLabel">
        <NuxtLink
